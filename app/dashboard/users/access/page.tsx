...
export default function TeamAccessPage() {
  ...
  async function createMember(event: React.FormEvent) {
    ...
    setForm({ name: '', email: '', password: '' }); setMessage('Acesso da sócia criado com sucesso.'); await load();
  }
