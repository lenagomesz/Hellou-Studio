...
export default async function BonusPage() {
  ...
  return (
    <div className="space-y-6 text-slate-900 dark:text-slate-100">
      <header className="relative overflow-hidden rounded-[28px] border border-pink-100 bg-gradient-to-br from-white via-pink-50 to-orange-50 p-7 text-slate-950 shadow-sm dark:border-pink-200 dark:from-white dark:via-pink-50 dark:to-orange-50 dark:text-slate-950 sm:p-9"><div className="absolute -right-20 -top-20 h-56 w-56 rounded-full bg-pink-300/30 blur-3xl" /><div className="relative"><span className="flex h-12 w-12 items-center justify-center rounded-2xl bg-gradient-to-br from-pink-500 to-orange-400 text-white shadow-lg"><Gift className="h-6 w-6" /></span><p className="mt-5 text-[10px] font-bold uppercase tracking-[0.2em] text-pink-600">Clube Hellou</p><h1 className="mt-1 text-3xl font-bold">Seus bônus exclusivos</h1><p className="mt-2 max-w-xl text-sm leading-6 text-slate-600">Vantagens liberadas especialmente para sua conta. Use o código no carrinho antes que expire.</p></div></header>
