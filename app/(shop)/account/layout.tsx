      ...
      <div className="grid gap-5 sm:gap-8 lg:grid-cols-[240px_1fr]">
        ...
        <aside className="hidden lg:block">
          <div className="sticky top-24 space-y-1">
            <div className="mb-6 rounded-2xl border border-gray-100 dark:border-gray-800 bg-white dark:bg-gray-900 p-4 shadow-sm">
              ...
              <p className="mt-3 text-sm font-semibold text-gray-900 dark:text-white truncate">
                {user.name ?? 'Usuário'}
              </p>
            ...
            {NAV_ITEMS.map((item) => (
              <Link
                key={item.href}
                href={item.href}
                className="flex items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-medium text-gray-700 dark:text-gray-300 transition hover:bg-gray-50 dark:hover:bg-gray-800 hover:text-orange-600"
              >
