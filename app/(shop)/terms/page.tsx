...
export default function TermsPage() {
  return (
    <main className="mx-auto max-w-3xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <p className="mt-2 text-sm text-gray-500">Última atualização: 10 de junho de 2026</p>

      <div className="mt-10 space-y-10 text-sm leading-relaxed text-gray-700">
        {/* Termos de Uso */}
        <section>
          <h2 className="text-lg font-semibold text-gray-900 font-display">1. Termos de Uso</h2>

          <h3 className="mt-4 font-semibold text-gray-800">1.1 Aceitação dos Termos</h3>
          <p className="mt-2">
          ...
          <h3 className="mt-4 font-semibold text-gray-800">1.2 Descrição do Serviço</h3>
          <p className="mt-2">
          ...
          <h3 className="mt-4 font-semibold text-gray-800">1.3 Cadastro</h3>
          <p className="mt-2">
          ...
          <h3 className="mt-4 font-semibold text-gray-800">1.4 Preços e Pagamento</h3>
          <p className="mt-2">
          ...
          <h3 className="mt-4 font-semibold text-gray-800">1.5 Entrega</h3>
          <p className="mt-2">
          ...
          <h3 className="mt-4 font-semibold text-gray-800">1.6 Trocas e Devoluções</h3>
          <p className="mt-2">
          ...
          <h3 className="mt-4 font-semibold text-gray-800">1.7 Propriedade Intelectual</h3>
          <p className="mt-2">
          ...
          <h3 className="mt-4 font-semibold text-gray-800">1.8 Uso Adequado</h3>
          <p className="mt-2">
        ...
        <section>
          <h2 className="text-lg font-semibold text-gray-900 font-display">2. Política de Privacidade</h2>

          <h3 className="mt-4 font-semibold text-gray-800">2.1 Dados Coletados</h3>
          ...
          <h3 className="mt-4 font-semibold text-gray-800">2.2 Finalidade do Uso dos Dados</h3>
          ...
          <h3 className="mt-4 font-semibold text-gray-800">2.3 Compartilhamento de Dados</h3>
          <p className="mt-2">
          ...
          <h3 className="mt-4 font-semibold text-gray-800">2.4 Segurança</h3>
          <p className="mt-2">
          ...
          <h3 className="mt-4 font-semibold text-gray-800">2.5 Seus Direitos (LGPD)</h3>
          <p className="mt-2">
          ...
          <h3 className="mt-4 font-semibold text-gray-800">2.6 Cookies</h3>
          <p className="mt-2">
          ...
          <h3 className="mt-4 font-semibold text-gray-800">2.7 Alterações nesta Política</h3>
          <p className="mt-2">
        ...
        {/* Contato */}
        <section>
          <h2 className="text-lg font-semibold text-gray-900 font-display">3. Contato</h2>
          <p className="mt-2">
