...
export default function HomePage() {
  return (
    <div className="overflow-x-hidden bg-white dark:bg-gray-950">
      ...
      {/* CTA FINAL */}
      {/* ═══════════════════════════════════════════ */}
      <section className="relative overflow-hidden bg-gradient-to-r from-pink-50 via-orange-50 to-pink-50 dark:from-gray-900 dark:via-gray-950 dark:to-gray-900 py-20">
        <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="relative mx-auto max-w-4xl px-4 text-center sm:px-6">
          <ScrollReveal direction="scale">
            <h2 className="text-3xl font-bold tracking-tight text-gray-800 dark:text-white sm:text-4xl lg:text-5xl">
            ...
            <div className="mt-10 flex flex-wrap justify-center gap-4">
              ...
              <Link
                ...
                className="inline-flex items-center gap-2 rounded-full border-2 border-pink-200 dark:border-pink-800 bg-white dark:bg-gray-900 px-7 py-4 text-sm font-semibold text-gray-700 dark:text-gray-200 transition-all duration-300 hover:border-pink-300 dark:hover:border-pink-600 hover:shadow-md hover:scale-[1.02] active:scale-[0.98]"
              >
