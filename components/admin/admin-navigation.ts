...
export const ADMIN_NAVIGATION: AdminNavigationSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/dashboard/kits', label: 'Kits', description: 'Combinações de produtos exibidas na loja', icon: Gift, permission: 'settings.manage', keywords: 'combos conjuntos presentes' },
