...
export function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className={`fixed bottom-6 right-6 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg transition hover:scale-110 hover:shadow-xl ${hasFloatingCart ? 'md:flex hidden' : ''}`}
    >
